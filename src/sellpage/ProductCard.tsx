                      ...
                      <div className="flex justify-between items-center">
                        {cart[product.id] ? (
                          ...
                          <button
                            ...
                            className="focus:outline-none text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm py-2 px-4 transition-all"
                          >
                            Add to Cart
                          </button>
                        )}
